# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-10-13 04:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Short name that will be used uniquely on the platform.', max_length=30, unique=True, validators=[django.core.validators.RegexValidator(re.compile('^[\\w.@+-]+$', 32), 'Enter a valid username', 'This value should only contain letters, numbers,                   and characters @/./+/-/_.', 'invalid')], verbose_name='User')),
                ('email', models.EmailField(help_text='Email that will be used as username.', max_length=254, unique=True, verbose_name='E-mail')),
                ('name', models.CharField(blank=True, help_text='Full user name.', max_length=150, verbose_name='Name')),
