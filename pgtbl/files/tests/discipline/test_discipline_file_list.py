...
class DisciplineFileListTestCase(TestCase):
    ...
    def tearDown(self):
        ...
        DisciplineFile.objects.all().delete()
    ...
    def test_status_code_200(self):
        ...
        self.assertTemplateUsed(response, 'files/discipline/list.html')
        self.assertTemplateUsed(response, 'files/discipline/add_file.html')
