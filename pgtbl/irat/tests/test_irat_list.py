...
class ListIRATTestCase(TestCase):
    ...
    def test_status_code_200(self):
        ...
        self.assertTemplateUsed(response, 'irat/irat.html')
        self.assertTemplateUsed(response, 'irat/info.html')
        self.assertTemplateUsed(response, 'irat/date.html')
        self.assertTemplateUsed(response, 'irat/update.html')
        self.assertTemplateUsed(response, 'irat/progress_bar.html')
        self.assertTemplateUsed(response, 'irat/pagination.html')
    ...
    def test_context(self):
        ...
        self.assertTrue('irat_form' in response.context)
    ...
    def test_teacher_can_see_the_irat_list(self):
        """
        Teacher can see the iRAT list
    ...
    def test_teacher_can_see_the_closed_session_irat_list(self):
        """
        Teacher can see the iRAT list when session is closed
        with exercises questions.
        """
    ...
    def test_teacher_can_see_irat_before_started(self):
        """
        Teacher can see the test before datetime stipulated.
        """

        # Now = 10:00, iRAt = 10:01, iRAT finish = 10:31
        self.module.irat_datetime = self.now + timedelta(minutes=1)
        self.module.save()
    ...
    def test_teacher_can_see_irat_started(self):
        """
        Teacher can see the test in the datetime stipulated.
        """

        # Now = 10:00, iRAT = 9:50, iRAT finish = 10:20
        self.module.irat_datetime = self.now - timedelta(minutes=10)
        self.module.save()
    ...
    def test_teacher_can_see_irat_after_finished(self):
        """
        Teacher can see the test after datetime stipulated.
        """

        # Now = 10:00, iRAT = 9:25, iRAt finish = 9:55
        self.module.irat_datetime = self.now - timedelta(minutes=self.module.irat_duration + 1)
        self.module.save()
    ...
    def test_teacher_monitor_can_see_the_irat_list(self):
        """
        Teacher monitor can see the iRAT list
        with exercises questions.
        """
    ...
    def test_teacher_monitor_can_see_the_closed_session_irat(self):
        """
        Teacher monitor can see the iRAT list when session is closed
        with exercises questions.
        """
    ...
    def test_teacher_monitor_can_see_irat_before_started(self):
        """
    ...
    def test_teacher_monitor_can_see_irat_started(self):
        """
    ...
    def test_teacher_monitor_can_see_irat_after_finished(self):
        """
    ...
    def test_monitor_can_not_see_the_irat_list(self):
        """
        Monitor can not see the iRAT list
        with exercises questions.
        """
    ...
    def test_monitor_can_not_see_the_closed_session_irat(self):
        """
        Monitor can not see the iRAT list when session is closed
        with exercises questions.
        """
    ...
    def test_monitor_can_not_see_irat_before_started(self):
        """
    ...
    def test_monitor_can_not_see_irat_started(self):
        """
    ...
    def test_monitor_can_not_see_irat_after_finished(self):
        """
    ...
    def test_student_can_not_see_the_irat_list(self):
        """
        Student can not see the iRAT list
        with exercises questions.
        """
    ...
    def test_student_can_not_see_the_closed_session_irat(self):
        """
        Student can not see the iRAT list when session is closed
        with exercises questions.
        """
    ...
    def test_student_can_not_see_irat_before_started(self):
        """
    ...
    def test_student_can_see_irat_started(self):
        """
    ...
    def test_student_can_not_see_irat_after_finished(self):
        """
        Monitor can not see the test after datetime stipulated.
        """
    ...
    def test_user_can_not_see_the_irat_list(self):
        """
        User that is not into discipline can not see the iRAT list
        with exercises questions.
        """
    ...
    def test_user_can_not_see_the_closed_session_irat(self):
        """
        User that is not into discipline can not see the iRAT list when session is closed
        with exercises questions.
        """
    ...
    def test_user_can_not_see_irat_before_started(self):
        """
    ...
    def test_user_can_not_see_irat_started(self):
        """
    ...
    def test_user_can_not_see_irat_after_finished(self):
        """
