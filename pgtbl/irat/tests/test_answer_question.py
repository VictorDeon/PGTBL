...
class ListIRATTestCase(TestCase):
    """
    Test to list question into iRAT.
    """
    ...
    def test_correct_answer_ok(self):
        ...
        self.assertEqual(4, IRATSubmission.objects.first().score)
        check_messages(
            self, response,
            tag='alert-success',
    ...
    def test_three_points_correct_answer(self):
        ...
        self.assertRedirects(response, self.redirect_url + "?page=1")
        self.assertEqual(IRATSubmission.objects.count(), 1)
        self.assertEqual(3, IRATSubmission.objects.first().score)
        check_messages(
            self, response,
            tag='alert-success',
            content="Question answered successfully."
    ...
    def test_one_points_correct_answer(self):
        ...
        self.assertRedirects(response, self.redirect_url + "?page=1")
        self.assertEqual(IRATSubmission.objects.count(), 1)
        self.assertEqual(1, IRATSubmission.objects.first().score)
        check_messages(
            self, response,
            tag='alert-success',
            content="Question answered successfully."
    ...
    def test_zero_points_correct_answer(self):
        ...
        self.assertRedirects(response, self.redirect_url + "?page=1")
        self.assertEqual(IRATSubmission.objects.count(), 1)
        self.assertEqual(0, IRATSubmission.objects.first().score)
        check_messages(
            self, response,
            tag='alert-success',
            content="Question answered successfully."
