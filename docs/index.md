...
O prazo limite para completar as atividade é 01/01/2019.
...
O responsável pela realização dessa atividade é a equipe especificada no [Termo de abertura do projeto](tap)
...
Como será realizado as atividade se encontra nos [Termo de abertura do projeto](tap)

### Por quanto?

Uma noção dos custos do projeto se encontra no [Termo de abertura do projeto](tap)
